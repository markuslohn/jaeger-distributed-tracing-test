...
public final class ServiceB {
  ...
  public Response processRequest(
    ...
    log.info(String.format("Received id=%s and data=%s at ServiceB", id, data.name));

    return Response.ok(String.format("Successfully processed request %s for ServiceB", id)).build();
  }
